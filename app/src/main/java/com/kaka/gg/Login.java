    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        autologin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (res.equals("Su")) {
                    id.setText("");
                    pw.setText("");
                    Toast.makeText(Login.this, shard.getString("name", "") + "님 자동로그인 성공", Toast.LENGTH_SHORT).show();
                    Intent i = new Intent(Login.this, MainActivity.class);
                    i.putExtra("newid", shard.getString("name", ""));
                    startActivity(i);
                } else {
                    Toast.makeText(Login.this, "로그인을 한 번 이상 해주십시오", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        autostop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                res = lc.gets();
                if (res.equals("fail")) {
                    Toast.makeText(Login.this, "해제할 아이디가 없습니다", Toast.LENGTH_SHORT).show();
                } else {
                    editor = shard.edit();
                    editor.clear();
                    editor.commit();
                    Toast.makeText(Login.this, lc.Name.get(lc.k).toString().trim() + "님 자동로그인 해제", Toast.LENGTH_SHORT).show();
                }
            }
        });
